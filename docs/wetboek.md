...
| Officiële naam            | Algemeen Wetboek DamskoRP |
| Citeertitel               | Wetboek DamskoRP |
...
1. Het Wetboek DamskoRP (verder aangeduid als WTDA) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WTDA heeft betrekking op het vaste land, de gemeente, en de stad DamskoRP.
3. Het WTDA is nauw verweven met de Algemene Plaatselijke Verordening DamskoRP (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen DamskoRP op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in DamskoRP niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van DamskoRP waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding;
...
---------------------
*Wetboek DamskoRP is opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad “DamskoRP”, opgetekend door Bram Mosterdfiets, te DamskoRP.*
